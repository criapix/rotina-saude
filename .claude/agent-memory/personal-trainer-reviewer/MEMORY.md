# Memory Index — Personal Trainer Reviewer

## Aluno e Contexto
- [user_profile.md](user_profile.md) — Perfil completo do aluno: restrições físicas (ombro, coluna), objetivos, nível, equipamentos disponíveis
...
- [project_joelho_fase2_retorno.md](project_joelho_fase2_retorno.md) — Fase 2 ativa desde 21/05/2026: extensora 0–60° reintroduzida em B e D, leg press 80–90°, mesa flexora voltou a 4 sets em D; volumes vigentes e critérios de progressão para Fase 3 (~11/06/2026)
