...
### Pré-pedal (~5:30) — alto carbo, baixa gordura, fácil digestão
Escolha uma opção:

| Opção | O que |
|---|---|
| A | Tapioca grande (60g goma) + peito de peru 80g + banana + suco |
| B | Pão de forma 3 fatias + peito de peru 80g + requeijão light + suco |
| C | Tapioca (50g goma) + ovo mexido 1 + mel 1 col. + banana + café com leite |
| D | Pão de forma 3 fatias + ovo mexido 2 + banana + suco |

### Dia normal (~7–8h) — academia ou descanso
Escolha uma opção:

| Opção | O que |
|---|---|
| 1 | Pão de forma 2 fatias + queijo minas 2 fatias + ovo mexido 2 + café com leite |
| 2 | Tapioca (50g goma) + queijo minas 2 fatias + peito de peru 60g + café com leite |
| 3 | Iogurte Probio2 170g + aveia 40g + banana + mel 1 col. + café |
| 4 | Pão de forma 2 fatias + manteiga + ovo cozido 2 + iogurte Probio2 170g + café |
| 5 | Tapioca (40g goma) + requeijão + ovo 1 + iogurte Probio2 170g + café |
...
| **Jantar ~20h** | Batata 250g + 3 ovos + 30g de queijo minas ou 80g de peito de peru (elevar proteína do jantar) + legumes + azeite |
...
| **Vitamina C** | 500 mg/dia (250mg 2x) | Com colágeno + almoço. Co-fator síntese colágeno. |
| **Zinco quelato** | 15-30 mg/dia | Jantar. Suporte hormonal (testosterona). |
...
## Estratégia anti-inflamatória alimentar

**Incluir diariamente:**

- Cúrcuma (3-5g) com pimenta-do-reino
- Gengibre fresco (1-2 cm)
- Frutas vermelhas (1 xícara/dia)
- Azeite extra-virgem (2-3 colheres/dia)
- Nozes/castanhas (30g/dia)
...
## Exames com impacto nutricional (10/02/2026)

| Exame | Resultado | Status | Ação nutricional |
|---|---|---|---|
| **CK** | 480 U/L (ref 35-232) | ⚠️ ELEVADO | Manter proteína alta + hidratação agressiva + deload |
| **Vitamina D** | 28,2 ng/mL (ideal 30-60) | ⚠️ BAIXO | D3 5000 UI/dia; reavaliar abril/2026 |
| **HDL** | 43 mg/dL (ideal >50) | ⚠️ BAIXO | Omega-3 3g/dia + pedal |
| **CHCM** | 36,6 (ref 31,4-36,0) | ⚠️ LEVE ALTO | Desidratação leve — reforçar hidratação |

> Exames completos e interpretação clínica em `dados-saude.md` seção 12. Pendências laboratoriais em `dados-saude.md` seção 14.
